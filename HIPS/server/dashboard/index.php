...
<div class="login-page">
    <div class="login-card animate-scaleIn">
        ...
        <?php elseif ($error === 'invalid_token'): ?>
            <div class="login-error">⚠ Invalid API token. Please verify your token.</div>
        <?php elseif ($error === 'missing_credentials'): ?>
            <div class="login-error">⚠ Please fill in all required fields.</div>
        <?php elseif ($error === 'server_error'): ?>
            <div class="login-error">⚠ Server error. Please check XAMPP services.</div>
        <?php endif; ?>
