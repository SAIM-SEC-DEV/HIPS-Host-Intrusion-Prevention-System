...
<div class="app-layout">
    ...
    <main class="main-content">
        ...
        <div class="stat-grid">
            <div class="stat-card red animate-fadeIn delay-1"><div class="stat-icon">🛡</div><div class="stat-value"><?= $totalBlocked ?></div><div class="stat-label">Threats Blocked</div></div>
            <div class="stat-card blue animate-fadeIn delay-2"><div class="stat-icon">📁</div><div class="stat-value"><?= $totalFileEvt ?></div><div class="stat-label">File Events</div></div>
            <div class="stat-card cyan animate-fadeIn delay-3"><div class="stat-icon">🌐</div><div class="stat-value"><?= $totalNetEvt ?></div><div class="stat-label">Network Events</div></div>
            <div class="stat-card green animate-fadeIn delay-4"><div class="stat-icon">⚡</div><div class="stat-value">&lt;2s</div><div class="stat-label">Avg Response Time</div></div>
        </div>

        <div class="grid-2" style="margin-bottom:20px;">
            <!-- Threat Distribution -->
            <div class="card animate-fadeIn delay-2">
                <div class="card-title"><span class="icon">📊</span> Threat Distribution</div>
            ...
            <div class="card animate-fadeIn delay-3">
                <div class="card-title"><span class="icon">📈</span> Weekly Threat Trend</div>
                <div class="chart-container" style="height:220px;">
        ...
        <div class="grid-2-1">
            <!-- Top Threat Types -->
            <div class="card animate-fadeIn delay-3">
                <div class="card-title"><span class="icon">🏆</span> Top Threat Types</div>
            ...
            <div class="card animate-fadeIn delay-4">
                <div class="card-title"><span class="icon">📤</span> Export Reports</div>
                ...
                <div style="display:flex;flex-direction:column;gap:10px;">
                    <a href="#" onclick="exportReport('pdf')" class="btn btn-secondary" style="justify-content:flex-start;text-decoration:none;">📄 PDF Summary Report</a>
                    <a href="#" onclick="exportReport('excel')" class="btn btn-secondary" style="justify-content:flex-start;text-decoration:none;">📊 Excel Event Log</a>
                    <a href="#" onclick="exportReport('csv')" class="btn btn-secondary" style="justify-content:flex-start;text-decoration:none;">📋 CSV Raw Data Export</a>
                    <button class="btn btn-secondary" style="justify-content:flex-start;" onclick="window.print();">🖨 Print This Page</button>
                </div>
