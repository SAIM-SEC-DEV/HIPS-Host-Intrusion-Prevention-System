...
public class CommandPoller {
    ...
    private void executeCommand(Command cmd) {
        ...
        if (handler == null) {
            ...
            apiClient.reportCommandResult(cmd.getId(), "failed",
                    Map.of("error", "No handler for command type: " + type));
            return;
        }
        ...
        try {
            ...
            apiClient.reportCommandResult(cmd.getId(), "completed",
                    result != null ? result : Map.of("message", "Command executed successfully."));
