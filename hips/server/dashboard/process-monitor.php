...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style.css?v=8.5">
...
<div class="app-layout">
    ...
    <main class="main-content">
        ...
        <div class="card animate-fadeIn delay-2">
            <div class="card-title"><span class="icon"><i class="fa-solid fa-microchip"></i></span> Process Execution Events</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size:11px;color:var(--text-muted);">
                            <?php if (!empty($e['mitre_technique_id'])): ?>
                            <span style="color:var(--accent-violet);"><i class="fa-solid fa-shield-halved"></i> <?= htmlspecialchars($e['mitre_technique_id']) ?></span>
                            <?php else: ?>
