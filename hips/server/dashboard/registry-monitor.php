...
<div class="app-layout">
    ...
    <main class="main-content">
        ...
        <div class="card animate-fadeIn delay-2">
            <div class="card-title"><span class="icon"><i class="fa-solid fa-file-signature"></i></span> Registry Integrity Events</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size:11px;color:var(--text-secondary);">
                            ...
                            <i class="fa-solid fa-shield-halved"></i> <?= htmlspecialchars($e['mitre_technique_id']) ?>
                            <?php endif; ?>
                        </td>
                    </tr>
