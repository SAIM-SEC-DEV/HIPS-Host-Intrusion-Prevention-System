...
CREATE TABLE IF NOT EXISTS `events` (
    ...
    `module`          ENUM('file','network','process','registry','memory','asset')
...
-- ============================================================
-- TABLE: ip_whitelist
-- Purpose: Stores IPs that should be excluded from network
--          threat analysis by the monitoring agent.
-- ============================================================
...
-- Default admin: username = admin, password = HipsAdmin@2024
-- The hash below is a bcrypt hash of 'HipsAdmin@2024'
INSERT INTO `dashboard_users` (`username`, `password_hash`, `display_name`, `role`, `api_token`, `must_change_password`)
VALUES (
    'admin',
    '$2y$12$vc7z6G.1ewSjdrbnRXf4H.ycZuefWtBXG/MfbpBKJB8t9bBrue15e',
